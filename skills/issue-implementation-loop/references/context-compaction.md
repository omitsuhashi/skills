...
`Execution Envelope.context_policy.session_compaction` is the session-level policy. It is required by the current-only Envelope v4 contract and must contain:
