...
description: Use when a user requests a repeatable development operating mode for large designs involving Grill with Docs, PRD/spec synthesis, issue decomposition, git worktrees, TDD, goal loops, or PR review.
---
