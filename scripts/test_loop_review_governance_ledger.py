...
class LoopReviewGovernanceLedgerTests(unittest.TestCase):
    ...
    def test_ledger_aggregates_lrg001_through_lrg005_evidence_and_pending_decisions(self) -> None:
        ...
        for required in (
            ...
            "HC-LRG-004-001",
            "`pending_decision`",
            "未判断 hardening candidate は実装しない",
        ):
    ...
    def test_index_and_log_expose_execution_artifacts_and_gate_evidence(self) -> None:
        ...
        for required in (
            ...
            "LRG-001 から LRG-004 は PR_READY / review approved",
    ...
    def test_execution_envelope_and_handoff_brief_are_discoverable_artifacts(self) -> None:
        ...
        for required in (
            ...
            '"hardening_candidate_auto_fix": false',
            '"candidate_decision_required_before_final_pr": true',
        ):
        ...
        self.assertIn('"candidate_decision_required_before_final_pr": true', packet_text)
