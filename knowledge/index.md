...
- [SDD 実装前コンテキスト分離仕様](wiki/syntheses/sdd-preimplementation-context-isolation-spec.md) — Planning ControllerをHuman対話・判断・approval・routingへ限定し、repository調査、Spec Synthesis、Plan Authoringをfresh workerへ委譲するfocused revisionのWritten Spec review candidate。
