...
- [SDD Implementation Skill 設計](wiki/syntheses/sdd-implementation-skill-design.md) — Superpowersを開発方法論の正本とし、spec stageへGrill with Docs、durable knowledge lifecycleへLLM Wiki、host boundaryへmodel resolutionとoptional reasoning effortを組み込む後継Written Spec候補。
