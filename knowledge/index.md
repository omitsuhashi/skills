...
- [[wiki/syntheses/task-management-hermes-readiness/implementation-plan|Task Management Hermes Schedule Secretary Readiness Implementation Plan]] — approved portable semanticsをfixture-backed Skills TDDと、Companies current-main reconciliation・後続live Gateを失わないcross-repository handoffへ分解したExecution Plan Gate候補。
