...
- [SDD Implementation Skill 設計](wiki/syntheses/sdd-implementation-skill-design.md) — Superpowersを開発方法論の正本とするHuman-approved Written Spec。Superpowers-first revisionは実装、task review、knowledge closeout、最終whole-branch review、bounded fixとscoped re-reviewまで完了し、locally completeである。
