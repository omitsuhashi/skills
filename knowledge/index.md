...
- [SDD Implementation Skill 設計](wiki/syntheses/sdd-implementation-skill-design.md) — Superpowersを開発方法論の正本とするHuman-approved Written Spec。Superpowers-first revisionはlocally completeであり、Phase 2ではSDDを唯一のuser-facing実装入口として旧loop familyをcurrent treeから削除した。
