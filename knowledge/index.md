...
- [Portfolio OS Task Backend Plugin Skill Issues](wiki/syntheses/portfolio-os-task-backend-plugin-skill-issues.md) — `portfolio-os-task-backend-plugin-skill` のcanonical local-first ledger。POTASK-001からPOTASK-011の完了履歴、Issue Gate承認済みPOTASK-012からPOTASK-019、worker実装・review・例外cycleの進捗証跡を集約する。
