...
- [[wiki/syntheses/task-management-hermes-readiness/spec|Task Management Hermes Schedule Secretary Readiness 仕様]] — operation-scoped preflight、Status-filtered pagination、reopen、portable/managed-native/live readinessの責務分離と外部deliveryを定義するpersonal-use MVPのWritten Spec review candidate。
