...
- [[wiki/syntheses/task-management-hermes-readiness/implementation-plan|Task Management Hermes Schedule Secretary Readiness Implementation Plan]] — `Human-approved / current`。portable Skills Tasks 1〜5はlocal実装済みで、Task 5独立review、Task 6 cross-repository handoff、controller-owned whole-branch closeoutはpending。Companies current-main reconciliationと後続live Gateは未実行のまま保持する。
