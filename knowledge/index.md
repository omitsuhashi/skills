...
- [SDD Implementation Skill 設計](wiki/syntheses/sdd-implementation-skill-design.md) — Superpowersを開発方法論の正本とし、Planning Controller、Control Return、fresh pre-implementation workerを含むskill behaviorを、入力・依存skill・active runtime capabilityだけで解決するcompatibility-freeのHuman-approved Written Spec。
