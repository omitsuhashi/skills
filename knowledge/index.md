...
- [[wiki/syntheses/task-management-hermes-readiness/issues|Task Management Hermes Schedule Secretary Readiness Issue 台帳]] — `local-portable-review-complete`。Tasks 1〜5のexact commit、独立task review、portable acceptance mapping、5回のwhole-branch FAILとfix wave、最終PASS（Critical 0 / Important 0 / Minor 0）を保持するlocal-first台帳。Task 6はmerged revision待ちでblockedであり、overall/live readinessやremote publication readinessは未判定。
