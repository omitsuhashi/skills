...
- [SDD Reasoning Effort Risk Precedence Implementation Plan](wiki/syntheses/sdd-effort-risk-precedence-implementation-plan.md) — high-risk task reviewをhighとして扱い、共有default effort vocabularyを増やさない変更はTask 1実装・独立review承認済みで、final whole-branch review待ちのcurrent closeout candidate。
