...
| loop-skill-operational-simplicity | LSOS-002 | loop 系 mental model を 1 ページ化する | 承認済み | 実行可能 | LSOS-001 | LSOS-004 | 未作成 | 未実施 | 未作成 |
...
- LSOS-002: 実行可能。LSOS-001 の適用基準を前提に mental model を作る。
