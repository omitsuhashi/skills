...
| LSCC-005 | `20f0628c70a1bddef618725ba93f09e9be184fb9..HEAD` | local ledger、normalized input packet、Execution Envelope、handoff brief、index、log を同期 | coordinator review pending | full verification command set OK。`report_skill_context.py --all --session-pressure-percent 75 --fail-on-warning` は hard-stop warning 固定のため expected exit 2 | remote write は未承認。LSCC-005 review は未実施 |
