---
summary: Loop Review Simplicity And Phase Skills Issue 台帳のローカルIssue、依存関係、実装結果、レビュー証跡と残課題を確認できる。
...
`LRSP-001`のschema v3、phase-scoped skill、material review、TDD、417 tests、cycle 2 review承認、local `PR_READY` evidenceを持つ完了台帳。
