...
- future-only hardening を routine review から外し、Issue 意図適合、今回変更による regression、current PR delivery risk、`safety_escalation`、`classification_needed` に review scope を絞った
